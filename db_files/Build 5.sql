...
INSERT INTO `sessions` VALUES ('1oNgvspYxkohY0nsq60d9yIjCe6LjV9v',1605390809,'{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{}}');
...
INSERT INTO `usuario` VALUES (1,'strahd','1234','correo@gmail.com','0'),(2,'Litle_One','Albatross97','bgdia_npc@gmail.com',NULL);
...
BEGIN
    ...
    where not exists(SELECT * from amigo where usuario1=temp.user1 and usuario2=temp.user2);
END ;;
DELIMITER ;
...
-- Dump completed on 2020-11-14 15:32:27
