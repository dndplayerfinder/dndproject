...
INSERT INTO `foro` VALUES (1,'Dudas','2020-11-20',NULL),(2,'Dudas','2020-11-20',NULL),(3,'Dudas','2020-11-20',NULL),(4,'Dudas','2020-11-20',NULL),(5,'Lore','2020-11-20',NULL),(6,'Lore','2020-11-20',NULL),(7,'Dudas','2020-11-20',NULL),(8,'Dudas','2020-11-20',NULL),(9,'Dudas','2020-11-20',NULL),(10,'Pjs','2020-11-20',NULL),(11,'Dudas','2020-11-20',NULL),(12,'Dudas','2020-11-20',NULL),(13,'Dudas','2020-11-20','Foro para contestar dudas');
...
INSERT INTO `grupo_foro` VALUES (1,2),(1,10),(5,4),(5,5),(5,6),(8,6),(9,7),(9,8),(10,9),(25,11),(26,12),(28,13);
...
INSERT INTO `grupo_manual` VALUES (19,5),(19,6),(19,7),(20,2),(20,7),(20,8),(20,9),(21,3),(21,5),(21,6),(22,1),(22,7),(22,8),(22,9),(23,6),(23,7),(23,8),(23,9),(26,4),(28,9);
...
INSERT INTO `grupo_usuario` VALUES (1,1),(1,2),(1,3),(1,5),(4,1),(4,2),(4,5),(13,1),(16,1),(20,1),(21,1),(22,1),(23,5),(24,6),(25,1),(26,6),(27,1),(28,3);
...
INSERT INTO `sessions` VALUES ('J4PphK77x2ByjlDgD5H1HSZYSCjDUxAf',1606027525,'{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{},\"login\":\"Ravengard\",\"img\":{\"type\":\"Buffer\",\"data\":[48]},\"user_id\":3,\"mail\":\"ulder.ravengard@gmail.com\",\"pwd\":\"qweQWE123\",\"rating\":4}');
...
/*!50001 VIEW `foro_info` AS select `f`.`foro_id` AS `foro_id`,`f`.`nombre` AS `nombre`,`gf`.`grupo_id` AS `grupo_id`,`f`.`descr` AS `descr` from (`grupo_foro` `gf` join `foro` `f` on(`gf`.`foro_id` = `f`.`foro_id`)) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `miembros` AS select `gu`.`grupo_id` AS `grupo_id`,`gu`.`usuario_id` AS `usuario_id`,`g`.`Nombre` AS `Nombre`,`g`.`dm` AS `dm` from (`grupo_usuario` `gu` join `grupo` `g` on(`gu`.`grupo_id` = `g`.`grupo_id`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-11-20 22:46:43
